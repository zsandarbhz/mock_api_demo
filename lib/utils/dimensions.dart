...
class Dimensions {
  ...
  static const double size_15 = 14.0;
  ...
  static double spaceBwTextFields = 24.0;
  static const double topSpace = 30.0;
  static const double topSpaceAuth = 40.0;
  static const double splashLogoWidth = 150.0;
  static const double headingToRowSpace = 18;


  static const double globalHorizontalPaddingForAuth = 30.0;
  static const double globalHorizontalPadding = 15.0;
  static const double bottomSheetRadius = 16.0;
  static const double profileImageSize = 100.0;
  static const double profileImageSizeMedium = 120.0;
  static const double profileImageSizeLarge = 150.0;
  static double productViewHeight = 100.0;
}
